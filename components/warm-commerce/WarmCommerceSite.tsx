    ...
    <article className={styles.productCard}>
      ...
      <div className={styles.productCopy}>
        ...
        <div>
          ...
          <a href={orderUrl} target="_blank" rel="noopener noreferrer" aria-label={`Tanyakan ${product.name} lewat WhatsApp`}>
    ...
    <div className={styles.site}>
      ...
      <header className={styles.header}>
        <div className={styles.headerInner}>
          ...
          <a href={orderUrl} target="_blank" rel="noopener noreferrer" className={styles.headerAction}>
        ...
        {menuOpen && (
          <nav id="dapur-rona-mobile-menu" className={styles.mobileNav} aria-label="Navigasi mobile Dapur Rona">
            ...
            <a href={orderUrl} target="_blank" rel="noopener noreferrer" onClick={closeMenu}>
          ...
          <div className={styles.heroInner}>
            <div className={styles.heroCopy}>
              ...
              <div className={styles.heroActions}>
                ...
                <a href={orderUrl} target="_blank" rel="noopener noreferrer" className={styles.textAction}>
        ...
        <section className={styles.promo} aria-labelledby="promo-title">
          <div className={styles.promoInner}>
            ...
            <div className={styles.promoCopy}>
              ...
              <a href={orderUrl} target="_blank" rel="noopener noreferrer" className={styles.promoAction}>
        ...
        <section className={styles.finalCta} aria-labelledby="final-cta-title">
          <div className={styles.finalInner}>
            ...
            <div>
              ...
              <a href={orderUrl} target="_blank" rel="noopener noreferrer" className={styles.finalAction}>
