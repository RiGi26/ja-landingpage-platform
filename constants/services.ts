...
export const BUNDLES: Bundle[] = [
  {
    ...
    emoji: '🚀',
    name: 'Starter Bisnis',
    desc: 'Paket paling populer untuk UMKM yang baru mulai go-digital. Sudah termasuk WA notifikasi otomatis dan invoice digital.',
    hostingId: 'basic',
  ...
  },
  {
    ...
    emoji: '🛒',
    name: 'Toko Online',
    desc: 'Semua yang dibutuhkan untuk berjualan online: pembayaran, keranjang, ulasan, dan voucher promo.',
    hostingId: 'starter',
    addonIds: ['midtrans', 'cart', 'checkout', 'review', 'voucher'],
    normalPrice: 2400000,
    bundlePrice: 1899000,
  },
  {
    id: 'sekolah-digital',
    emoji: '🎓',
    name: 'Sekolah Digital',
    desc: 'Lengkap untuk lembaga pendidikan: PPDB, portal siswa, absensi, dan sertifikat otomatis.',
    hostingId: 'basic',
    addonIds: ['ppdb', 'portal-siswa', 'absensi', 'cert'],
    normalPrice: 1600000,
    bundlePrice: 1249000,
  },
  {
    ...
    emoji: '🏥',
    name: 'Klinik Online',
    desc: 'Website klinik profesional: antrian digital, jadwal dokter, reservasi online, dan rekam medis dasar.',
    hostingId: 'starter',
    addonIds: ['queue', 'doc-sched', 'clinic-res', 'med-record'],
    normalPrice: 2550000,
    bundlePrice: 1999000,
  },
  {
    ...
    emoji: '🚌',
    name: 'Travel & Rental',
    desc: 'Sistem booking lengkap: reservasi online, e-ticketing, jadwal driver, dan manajemen kursi.',
    hostingId: 'starter',
    addonIds: ['booking', 'e-ticket', 'driver-sched', 'seat'],
    normalPrice: 2400000,
    bundlePrice: 1899000,
  },
];
